...
int main(void)
{
    ...
    double growth(double dvdd,double dvfrag),ranryu();
    double dt1,dt2;
 ...
 /*出力終わり*/
    ...
    fprintf(fp,"# x=%lf vy=%lf rp=%lf rhop=%lf alpha=%lf dvfrag=%lf \n",x,vy,rp,rhop,alpha,dvfrag); 
...
/*円盤モデル*/
    ...
    /*円盤ダスト面密度g/cm2*/
    if(0.35<rt && rt<2.7){
        sigd = 7.1*pow(rt,-1.5); /*rock*/
    }else if(rt>2.7){
        sigd = 30*pow(rt,-1.5); /*rock+ice*/
    }
